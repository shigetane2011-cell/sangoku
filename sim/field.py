...
#
# 【実測して外れた】理屈は通っていたが、データは支持しなかった。
#
#   数え方        緩い弓係数  速い弓係数  跳び幅  速い設定の時間切れ%
#   秒 40         0.835     1.678   2.01倍       44%
#   消耗割合 0.20  0.764     1.203   1.58倍       89%
#   消耗割合 0.30  0.982     1.917   1.95倍       78%
#   消耗割合 0.45  1.197     3.329   2.78倍       50%
#
# 一見 0.20 が良いが、**弓の強さを揃えると差が消える**。秒方式は弓係数0.701で
# 跳び幅1.40、0.828で1.70なので、0.764 では内挿して約1.53。消耗割合0.20 の 1.58 より
# わずかに良い。しかも消耗割合では時間切れが 89% まで増える。
#
