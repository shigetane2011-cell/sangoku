...
ACT_COEF = {INF: 1.0000, CAV: 0.9843, ARC: 1.4427}
# **総合値の定義を変えたら必ず測り直すこと（§7.30）。** 兵力×攻撃力 から
# 兵力×√(攻撃力/間隔×(100+防御)/100) へ変えたとき、防御力の効きが半分になり、
# 防御の低い弓兵が得をしすぎた（0.8909 → 1.4427）。相性を切って測った3辺の幅は
# 5.380 → 0.099 コスト点。
