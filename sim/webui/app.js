      ...
      <div class="guide-panel panel">
        ...
        <dl class="guide-body terms">
          ...
          <dd>一定時間の増減。<b>同じ名の効果は重ならず、強いほう一つだけ</b>が効く。
            ...
            五割で頭打ち。</dd>
          <dt>兵法への備え・矢と刃への備え</dt>
          <dd>受ける損害そのものを減らす。前者は兵法、後者は矢と斬り合い。
            減らした分は軍功帳に<b>軽減</b>として出る。</dd>
          <dt>刃返し・返し討ち</dt>
          <dd>受けた分の一部を撃ち手へ返す。<b>刃返しは兵法を、返し討ちは
            矢と斬り合いを</b>返す。返した分は<b>反射</b>として出る。</dd>
          <dt>兵法打消し</dt>
          <dd>構えを受けた隊を狙う敵の兵法を<b>丸ごと退ける</b>。軽減と違い、
            当たらなかったことになる。<b>回数で尽きる</b>——数えた分だけ防いだら構えは下りる。</dd>
          <dt>畏怖・見切り</dt>
          <dd>畏怖は<b>敵の攻撃力</b>を下げ、見切りは<b>自分の防御力</b>を上げる。
            呼び名が違うだけで、増減の規則は上と同じ。</dd>
          <dt>吸収</dt>
          <dd>削った兵の一部が<b>そのままこちらの陣へ流れ込む</b>。
            損害と回復を一度に行う。</dd>
          <dt>一騎討ち</dt>
          <dd>名指しの敵を<b>乱軍から引きずり出す</b>。その間、ほかの敵は
            この武将に手が出せない。</dd>
          <dt>薙ぎ払い</dt>
          <dd>一振りが<b>同時に複数を薙ぐ</b>。相手が増えても一人あたりは
            薄まらない——どの相手にも同じ重さで入る。</dd>
          <dt>引き延ばし</dt>
          <dd><b>すでに敵に掛かっている</b>混乱・延焼・足止めを長引かせる。
            新しく掛ける力ではない。</dd>
          <dt>写し取り</dt>
          <dd>次に味方が放つ<b>その段の兵法</b>を、この武将がもう一度放つ。
            放つのはこの武将なので、効き目はこの武将の腕しだい。</dd>
          <dt>上書き</dt>
          <dd><b>攻めが上がっている敵ほど深く沈む</b>。強化を消すのではなく、
            弱体がより深く入る。</dd>
          <dt>反動</dt>
          <dd>放つたびに<b>自分が受ける</b>弱体。代償が兵を失うのに対し、
            こちらは能力が落ちる。</dd>
          <dt>気勢封じ</dt>
          <dd>その間、相手は<b>兵法を溜められない</b>。溜まっている分が
            減るのではなく、増えなくなる。</dd>
          <dt>崩れる・全滅</dt>
          <dd>兵が三割を割ると<b>崩れた</b>とみなし、一兵も残らなければ<b>全滅</b>。
            固有能力の引き金はこの二つを書き分けている。</dd>
          <dt>代償</dt>
          ...
          <dt>連発型・標準型・決戦型</dt>
          <dd>兵法の構え方。<b>連発型は軽く何度も、決戦型は重く一度きり</b>、
            標準型はその中間。決戦型は一撃が大きい代わりに遅く、
            打消しや気勢封じで<b>撃つ前に潰される</b>ことがある。</dd>
          <dt>抑制</dt>
      ...
      return `<div class="side-label">${label}${sum}</div>` + us.map((u, i) => {
        ...
        return `<div class="unit-row ${gone ? "dead" : ""} ${i % 2 ? "alt" : ""}">
          ...
          <span class="bars">
            ...
            ${(u.covered || 0) >= 50 ? `<span class="sk-note">馬前 ${k(u.covered)}</span>` : ""}
