...
TARGET_DMG_F = {
                ...
                '敵1体（前衛の兵力が最多）': 1.207,
                '敵1体（兵力が最多）': 0.645,   # 旧挙動の記録（データからは消滅済み） '敵1体（兵力が最少）': 1.647, '敵1体（正面）': 1.286,
...
TARGET_FX_FOE = {
                '敵1体（前衛の兵力が最多）': 0.480,   # 弱体 0.251/錨0.450 × 0.861
                '敵1体（兵力が最多）': 0.66,   # 旧挙動の記録 '敵1体（兵力が最少）': 0.587, '敵1体（正面）': 0.861,
